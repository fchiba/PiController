/*
 * Nintendo Switch USB HID Descriptors
 * Based on PicoSwitch-WirelessGamepadAdapter
...
// HAT report (4 bits) - D-pad directions
...
// USB HID Report Descriptor (86 bytes)
